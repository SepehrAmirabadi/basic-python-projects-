...
print("Start words should be", ['The', 'I', 'We', 'Check', 'A', 'Mary'])
...
print("Input Text:", string)
print("Start words should be", ['We', 'One', 'Writing', 'She', 'A', 'He', 'Anyone'])
print("Your start words are:", sentences.startwords(string))
